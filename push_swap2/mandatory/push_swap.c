...
static void	make_sort_array(t_env *env)
{
	...
	intex_stack_a(env);
	env->average_vvsmall = ((env->a_size / 7) * 1);
	env->average_vsmall = ((env->a_size / 7) * 2);
	env->average_small = ((env->a_size / 7) * 3);
	env->average_big = ((env->a_size / 7) * 4);
	env->average_vbig = ((env->a_size / 7) * 5);
	env->average_vvbig = ((env->a_size / 7) * 6);
}
